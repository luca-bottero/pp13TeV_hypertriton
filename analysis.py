...
data = training_ml.load_data_with_scores('./data/data_scores.csv')
background_ls = training_ml.load_data_with_scores('./data/bckg_ls_scores.csv')

eff_array, scores = training_ml.load_eff_scores()
print('Datas loaded\n')
